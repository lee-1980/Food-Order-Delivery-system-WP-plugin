    ...
    <form class="pl8app-wrapper" id="store-allergy-form" action="<?php echo admin_url( 'admin-post.php' ) ?>" method="POST">
        <p>
            <label> Your name<br>
        ...
        <p>
            <label> Your message<br>
                <span class="pl8app-form-control-wrap your-message">
                    <textarea name="pl8app-your-message" id="pl8app-your-message" cols="40" rows="10"
                              class="pl8app-form-control pl8app-textarea" aria-invalid="false">
                    </textarea>
                    <span class="pl8app-valid hidden" aria-hidden="true">*The field is required.</span>
                </span>
            </label>
        ...
        <p>
            <?php wp_nonce_field('pl8app_allergy_nonce', 'pl8app_allergy_nonce_field'); ?>
            <input type="hidden" name="action" value="pl8app_allergy_action"/>
