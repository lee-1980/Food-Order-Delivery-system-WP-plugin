...
class pl8app_Customer_Reports_Table extends WP_List_Table {
	...
	public function __construct() {
		...
		parent::__construct( array(
			'singular'  => __( 'Customer', 'pl8app' ),     // Singular name of the listed records
			'plural'    => __( 'Customers', 'pl8app' ),    // Plural name of the listed records
	...
	public function column_default( $item, $column_name ) {
		switch ( $column_name ) {
			...
			case 'menuitems' :
				...
				$value = '<a href="' . esc_url( admin_url( 'admin.php?page=pl8app-reports&tab=logs&user=' . urlencode( $user ) ) ) . '">' . __( 'View menuitem log', 'pl8app' ) . '</a>';
				break;
			default:
				$value = isset( $item[ $column_name ] ) ? $item[ $column_name ] : null;
				break;
		}
		return apply_filters( 'pl8app_report_column_' . $column_name, $value, $item['id'] );
	}
	...
	public function get_columns() {
		$columns = array(
			...
			'num_purchases' => __( 'Purchases', 'pl8app' ),
			'amount_spent'  => __( 'Total Spent', 'pl8app' ),
			'menuitems'=> __( 'Menu Items', 'pl8app' )
		);
	...
	public function prepare_items() {
		...
		$this->total = pl8app_count_total_customers();
