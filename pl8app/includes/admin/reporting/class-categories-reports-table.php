...
/**
 * pl8app_Categories_Reports_Table Class
 *
 * Renders the Reports table
 *
 * @since 2.4
 */
class pl8app_Categories_Reports_Table extends WP_List_Table {
	...
	public function reports_data() {
		...
		if ( false !== $cached_reports ) {
			...
			$categories = get_terms( 'menu-category', $term_args );
			...
			foreach ( $categories as $category_id => $category ) {
				...
				$child_terms = get_terms( 'menu-category', $child_args );
