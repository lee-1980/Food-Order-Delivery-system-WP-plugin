...
class pl8app_Batch_Import {
	...
	public function __construct( $_file = '', $_step = 1 ) {
		...
		if( ! class_exists( 'parseCSV' ) ) {
			require_once PL8_PLUGIN_DIR . 'includes/libraries/parsecsv.lib.php';
		}
	...
	public function can_import() {
		return (bool) apply_filters( 'pl8app_import_capability', current_user_can( $this->capability_type ) );
	}
