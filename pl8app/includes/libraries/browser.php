 ...
 *
 * Modified to work for pl8app by
 ...
 *
 * Modified to add formatted User Agent string for pl8app System Info by
 * Chris Christoff on 12/23/2012
 * Changes: Split user string and add formatting so we can print a nicely
 * formatted user agent string on the pl8app System Info
 *
 * File: Browser.php
