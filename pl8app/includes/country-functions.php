 ...
 */
function pl8app_get_shop_country() {
	$country = pl8app_get_option( 'base_country', 'US' );

	return apply_filters( 'pl8app_shop_country', $country );
}
 ...
 */
function pl8app_get_shop_state() {
	$state = pl8app_get_option( 'base_state', false );

	return apply_filters( 'pl8app_shop_state', $state );
}
 ...
 */
function pl8app_get_states( $country = null ) {
	if( empty( $country ) )
		$country = pl8app_get_shop_country();

	switch( $country ) :

		case 'US' :
			$states = pl8app_get_states_list();
			break;
		case 'AO' :
			$states = pl8app_get_angola_provinces_list();
			break;
		case 'CA' :
			$states = pl8app_get_provinces_list();
			break;
		case 'AU' :
			$states = pl8app_get_australian_states_list();
			break;
		case 'BD' :
			$states = pl8app_get_bangladeshi_states_list();
			break;
		case 'BG' :
			$states = pl8app_get_bulgarian_states_list();
			break;
		case 'BR' :
			$states = pl8app_get_brazil_states_list();
			break;
		case 'CN' :
			$states = pl8app_get_chinese_states_list();
			break;
		case 'GB' :
			$states = pl8app_get_united_kingdom_states_list();
			break;
		case 'HK' :
			$states = pl8app_get_hong_kong_states_list();
			break;
		case 'HU' :
			$states = pl8app_get_hungary_states_list();
			break;
		case 'ID' :
			$states = pl8app_get_indonesian_states_list();
			break;
		case 'IN' :
			$states = pl8app_get_indian_states_list();
			break;
		case 'IR' :
			$states = pl8app_get_iranian_states_list();
			break;
		case 'IT' :
			$states = pl8app_get_italian_states_list();
			break;
		case 'JP' :
			$states = pl8app_get_japanese_states_list();
			break;
		case 'MX' :
			$states = pl8app_get_mexican_states_list();
			break;
		case 'MY' :
			$states = pl8app_get_malaysian_states_list();
			break;
		case 'NP' :
			$states = pl8app_get_nepalese_states_list();
			break;
		case 'NZ' :
			$states = pl8app_get_new_zealand_states_list();
			break;
		case 'PE' :
			$states = pl8app_get_peruvian_states_list();
			break;
		case 'TH' :
			$states = pl8app_get_thailand_states_list();
			break;
		case 'TR' :
			$states = pl8app_get_turkey_states_list();
			break;
		case 'ZA' :
			$states = pl8app_get_south_african_states_list();
			break;
		case 'ES' :
			$states = pl8app_get_spain_states_list();
			break;
		default :
			$states = array();
			break;
	...
	return apply_filters( 'pl8app_shop_states', $states, $country );
}
 ...
 */
function pl8app_get_country_list() {
	$countries = array(
		''   => '',
		'US' => 'United States',
		'CA' => 'Canada',
	...
	return apply_filters( 'pl8app_countries', $countries );
}
 ...
 * @return      array
 */
function pl8app_get_states_list() {
	$states = array(
		''   => '',
		'AL' => 'Alabama',
		'AK' => 'Alaska',
	...
	return apply_filters( 'pl8app_us_states', $states );
}
 ...
 */
function pl8app_get_angola_provinces_list() {
	$provinces = array(
		''    => '',
		'BGO' => 'Bengo',
		'BGU' => 'Benguela',
	...
	return apply_filters( 'pl8app_angola_provinces', $provinces );
}
 ...
 * @return      array
 */
function pl8app_get_provinces_list() {
	$provinces = array(
		''   => '',
		'AB' => 'Alberta',
		'BC' => 'British Columbia',
	...
	return apply_filters( 'pl8app_canada_provinces', $provinces );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_australian_states_list() {
	$states = array(
		''    => '',
	...
	return apply_filters( 'pl8app_australian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_bangladeshi_states_list() {
	$states = array(
		''    => '',
		'BAG' => 'Bagerhat',
		'BAN' => 'Bandarban',
	...
	return apply_filters( 'pl8app_bangladeshi_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_brazil_states_list() {
	$states = array(
		''   => '',
		'AC' => 'Acre',
		'AL' => 'Alagoas',
	...
	return apply_filters( 'pl8app_brazil_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_bulgarian_states_list() {
	$states = array(
		''      => '',
		'BG-01' => 'Blagoevgrad',
		'BG-02' => 'Burgas',
	...
	return apply_filters( 'pl8app_bulgarian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_hong_kong_states_list() {
	$states = array(
		''                => '',
	...
	return apply_filters( 'pl8app_hong_kong_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_hungary_states_list() {
	$states = array(
		''   => '',
		'BK' => 'Bács-Kiskun',
		'BE' => 'Békés',
	...
	return apply_filters( 'pl8app_hungary_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_japanese_states_list() {
	$states = array(
		''     => '',
		'JP01' => 'Hokkaido',
		'JP02' => 'Aomori',
	...
	return apply_filters( 'pl8app_japanese_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_chinese_states_list() {
	$states = array(
		''     => '',
	    'CN1'  => 'Yunnan / &#20113;&#21335;',
	    'CN2'  => 'Beijing / &#21271;&#20140;',
	...
	return apply_filters( 'pl8app_chinese_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_united_kingdom_states_list() {
	$states = array(
	    ''	    	 => '',
	...
	return apply_filters( 'pl8app_united_kingdom_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_new_zealand_states_list() {
	$states = array(
		''   => '',
		'AK' => 'Auckland',
		'BP' => 'Bay of Plenty',
	...
	return apply_filters( 'pl8app_new_zealand_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_peruvian_states_list() {
	$states = array(
		''    => '',
		'CAL' => 'El Callao',
	...
	return apply_filters( 'pl8app_peruvian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_indonesian_states_list() {
	$states  = array(
		''   => '',
	...
	return apply_filters( 'pl8app_indonesia_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_indian_states_list() {
	$states = array(
		''   => '',
		'AP' => 'Andhra Pradesh',
	...
	return apply_filters( 'pl8app_indian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_iranian_states_list() {
	$states = array(
		''    => '',
		'KHZ' => 'Khuzestan',
		'THR' => 'Tehran',
	...
	return apply_filters( 'pl8app_iranian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_italian_states_list() {
	$states = array(
		''   => '',
		'AG' => 'Agrigento',
		'AL' => 'Alessandria',
	...
	return apply_filters( 'pl8app_italian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_malaysian_states_list() {
	$states = array(
		''    => '',
		'JHR' => 'Johor',
		'KDH' => 'Kedah',
	...
	return apply_filters( 'pl8app_malaysian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_mexican_states_list() {
	$states = array(
		''    => '',
	...
	return apply_filters( 'pl8app_mexican_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_nepalese_states_list() {
	$states = array(
		''    => '',
		'ILL' => 'Illam',
		'JHA' => 'Jhapa',
	...
	return apply_filters( 'pl8app_nepalese_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_south_african_states_list() {
	$states = array(
		''    => '',
		'EC'  => 'Eastern Cape',
		'FS'  => 'Free State',
	...
	return apply_filters( 'pl8app_south_african_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_thailand_states_list() {
	$states = array(
		''      => '',
	...
	return apply_filters( 'pl8app_thailand_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_turkey_states_list() {
	$states = array(
		''     => '',
		'TR01' => 'Adana',
		'TR02' => 'Ad&#305;yaman',
	...
	return apply_filters( 'pl8app_turkey_states', $states );
}
 ...
 * @return array $states A list of states
 */
function pl8app_get_spain_states_list() {
	$states = array(
		''   => '',
	    'C'  => __( 'A Coru&ntilde;a', 'pl8app' ),
	    'VI' => __( 'Araba', 'pl8app' ),
	    'AB' => __( 'Albacete', 'pl8app' ),
	    'A'  => __( 'Alicante', 'pl8app' ),
	    'AL' => __( 'Almer&iacute;a', 'pl8app' ),
	    'O'  => __( 'Asturias', 'pl8app' ),
	    'AV' => __( '&Aacute;vila', 'pl8app' ),
	    'BA' => __( 'Badajoz', 'pl8app' ),
	    'PM' => __( 'Baleares', 'pl8app' ),
	    'B'  => __( 'Barcelona', 'pl8app' ),
	    'BU' => __( 'Burgos', 'pl8app' ),
	    'CC' => __( 'C&aacute;ceres', 'pl8app' ),
	    'CA' => __( 'C&aacute;diz', 'pl8app' ),
	    'S'  => __( 'Cantabria', 'pl8app' ),
	    'CS' => __( 'Castell&oacute;n', 'pl8app' ),
	    'CE' => __( 'Ceuta', 'pl8app' ),
	    'CR' => __( 'Ciudad Real', 'pl8app' ),
	    'CO' => __( 'C&oacute;rdoba', 'pl8app' ),
	    'CU' => __( 'Cuenca', 'pl8app' ),
	    'GI' => __( 'Girona', 'pl8app' ),
	    'GR' => __( 'Granada', 'pl8app' ),
	    'GU' => __( 'Guadalajara', 'pl8app' ),
	    'SS' => __( 'Gipuzkoa', 'pl8app' ),
	    'H'  => __( 'Huelva', 'pl8app' ),
	    'HU' => __( 'Huesca', 'pl8app' ),
	    'J'  => __( 'Ja&eacute;n', 'pl8app' ),
	    'LO' => __( 'La Rioja', 'pl8app' ),
	    'GC' => __( 'Las Palmas', 'pl8app' ),
	    'LE' => __( 'Le&oacute;n', 'pl8app' ),
	    'L'  => __( 'Lleida', 'pl8app' ),
	    'LU' => __( 'Lugo', 'pl8app' ),
	    'M'  => __( 'Madrid', 'pl8app' ),
	    'MA' => __( 'M&aacute;laga', 'pl8app' ),
	    'ML' => __( 'Melilla', 'pl8app' ),
	    'MU' => __( 'Murcia', 'pl8app' ),
	    'NA' => __( 'Navarra', 'pl8app' ),
	    'OR' => __( 'Ourense', 'pl8app' ),
	    'P'  => __( 'Palencia', 'pl8app' ),
	    'PO' => __( 'Pontevedra', 'pl8app' ),
	    'SA' => __( 'Salamanca', 'pl8app' ),
	    'TF' => __( 'Santa Cruz de Tenerife', 'pl8app' ),
	    'SG' => __( 'Segovia', 'pl8app' ),
	    'SE' => __( 'Sevilla', 'pl8app' ),
	    'SO' => __( 'Soria', 'pl8app' ),
	    'T'  => __( 'Tarragona', 'pl8app' ),
	    'TE' => __( 'Teruel', 'pl8app' ),
	    'TO' => __( 'Toledo', 'pl8app' ),
	    'V'  => __( 'Valencia', 'pl8app' ),
	    'VA' => __( 'Valladolid', 'pl8app' ),
	    'BI' => __( 'Bizkaia', 'pl8app' ),
	    'ZA' => __( 'Zamora', 'pl8app' ),
	    'Z'  => __( 'Zaragoza', 'pl8app' )
	);

	return apply_filters( 'pl8app_spain_states', $states );
}
 ...
 * @return string
 */
function pl8app_get_country_name( $country_code = '' ) {
	$country_list = pl8app_get_country_list();
	$country_name = isset( $country_list[ $country_code ] ) ? $country_list[ $country_code ] : $country_code;

	return apply_filters( 'pl8app_get_country_name', $country_name, $country_code );
}
 ...
 * @return string
 */
function pl8app_get_state_name( $country_code = '', $state_code = '' ) {
	$states_list = pl8app_get_states( $country_code );
	$state_name  = isset( $states_list[ $state_code ] ) ? $states_list[ $state_code ] : $state_code;

	return apply_filters( 'pl8app_get_state_name', $state_name, $state_code );
}
