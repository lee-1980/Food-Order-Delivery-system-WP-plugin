...
/**
 * pl8app_DB_Customers Class
 *
 * @since  1.0.0
 */
class pl8app_DB_Customers extends pl8app_DB  {
	...
	*/
	public function __construct() {
		...
		$this->table_name  = $wpdb->prefix . 'pl8app_customers';
		$this->primary_key = 'id';
		$this->version     = '1.0';
	...
	*/
	 ...
	 * the payment meta and logs. Use pl8app_customer_delete() instead
	 *
	 * @since   2.3.1
	*/
	...
	*/
				...
				if( $success ) {
					...
					if( ! empty( $payments_array ) ) {
						...
						foreach ( $payments_array as $payment_id ) {
							...
							pl8app_update_payment_meta( $payment_id, 'email', $user->user_email );

						}

					}

					do_action( 'pl8app_update_customer_email_on_user_update', $user, $customer );
	...
	public function get_customer_by( $field = 'id', $value = 0 ) {
		...
		$query = new pl8app_Customer_Query( '', $this );
	...
	*/
	...
	/**
	 * Prepare query arguments for `pl8app_Customer_Query`.
	 *
	 ...
	 * @since 1.0.0
	 *
	 * @param array $args Arguments for `pl8app_Customer_Query`.
