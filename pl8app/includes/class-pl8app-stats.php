...
class pl8app_Stats {
	...
	public function get_predefined_dates() {
		...
		return apply_filters( 'pl8app_stats_predefined_dates', $predefined );
	}
	...
	public function convert_date( $date, $end_date = false ) {
		...
		if ( ( is_string( $date ) || is_int( $date ) ) && array_key_exists( $date, $this->get_predefined_dates() ) ) {
			...
			return new WP_Error( 'invalid_date', __( 'Improper date provided.', 'pl8app' ) );
		...
		return apply_filters( 'pl8app_stats_date', $date, $end_date, $this );
