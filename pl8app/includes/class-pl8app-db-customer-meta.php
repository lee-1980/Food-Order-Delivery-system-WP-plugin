...
class pl8app_DB_Customer_Meta extends pl8app_DB {
	...
	*/
	public function __construct() {
		...
		$this->table_name  = $wpdb->prefix . 'pl8app_customermeta';
	...
	*/
	 ...
	 *
	 * For internal use only. Use pl8app_Customer->get_meta() for public usage.
	 *
	 ...
	 *
	 * For internal use only. Use pl8app_Customer->add_meta() for public usage.
	 *
	 * @param   int    $customer_id   Customer ID.
	 ...
	 *
	 * For internal use only. Use pl8app_Customer->update_meta() for public usage.
	 *
	 ...
	 *
	 * For internal use only. Use pl8app_Customer->delete_meta() for public usage.
	 *
